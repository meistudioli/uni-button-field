...
`),INJECT_KEY=Symbol.for("uni.button.field.ui.injected"),uiInit=()=>{var e;window[INJECT_KEY]||((e=new CSSStyleSheet).replaceSync(styleInjection),document.adoptedStyleSheets=[...document.adoptedStyleSheets,e],window[INJECT_KEY]=!0)};uiInit();class UniButtonField extends HTMLElement{#data;#nodes;#config;constructor(e){super(),this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(template.content.cloneNode(!0)),this.#data={controller:""},this.#nodes={},this.#config={...defaults,...e}}async connectedCallback(){var{config:e,error:o}=await _wcl.getWCConfig(this);o?(console.warn(_wcl.classToTagName(this.constructor.name)+": "+o),this.remove()):(this.#config={...this.#config,...e},Object.keys(defaults).forEach(e=>this.#upgradeProperty(e)))}disconnectedCallback(){this.#data.controller.abort?.()}#format(e,o,r){if(null!==r)switch(e){case"appearance":this.#config[e]=["filled","outlined","text"].includes(r)?r:defaults.appearance;break;case"size":this.#config[e]=["large","medium","small"].includes(r)?r:defaults.size;break;case"theme":this.#config[e]=["main","moderate","inverse","success","danger"].includes(r)?r:defaults.theme}else booleanAttrs.includes(e)?this.#config[e]=!1:this.#config[e]=defaults[e]}attributeChangedCallback(e,o,r){UniButtonField.observedAttributes.includes(e)&&this.#format(e,o,r)}static get observedAttributes(){return Object.keys(defaults)}static get supportedEvents(){return Object.keys(custumEvents).map(e=>custumEvents[e])}#upgradeProperty(e){let o;UniButtonField.observedAttributes.includes(e)&&(Object.prototype.hasOwnProperty.call(this,e)?(o=this[e],delete this[e]):o=booleanAttrs.includes(e)?!(!this.hasAttribute(e)&&!this.#config[e]):objectAttrs.includes(e)?this.hasAttribute(e)?this.getAttribute(e):JSON.stringify(this.#config[e]):this.hasAttribute(e)?this.getAttribute(e):this.#config[e],this[e]=o)}set appearance(e){e?this.setAttribute("appearance",e):this.removeAttribute("appearance")}get appearance(){return this.#config.appearance}set size(e){e?this.setAttribute("size",e):this.removeAttribute("size")}get size(){return this.#config.size}set theme(e){e?this.setAttribute("theme",e):this.removeAttribute("theme")}get theme(){return this.#config.theme}refresh(){this.hidden=!0,this.offsetHeight,this.hidden=!1}}const S=_wcl.supports(),T=_wcl.classToTagName("UniButtonField");S.customElements&&S.shadowDOM&&S.template&&!window.customElements.get(T)&&window.customElements.define(_wcl.classToTagName("UniButtonField"),UniButtonField);export{UniButtonField};